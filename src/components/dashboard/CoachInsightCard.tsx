  ...
  if (error && !insight) {
    return (
      <div className="rounded-xl border border-border bg-card p-3 flex items-center gap-3">
        ...
        <p className="flex-1 text-sm text-muted-foreground">Coach Sven kon geen inzicht laden.</p>
        <button
  ...
  return (
    <div className="rounded-xl border border-primary/20 bg-primary/5 p-3 flex items-start gap-2.5">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[11px] font-semibold text-primary uppercase tracking-wide mb-0.5">Coach Sven</p>
