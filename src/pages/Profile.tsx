      ...
      <div className="max-w-2xl mx-auto space-y-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-5">
            <p className="text-sm text-muted-foreground">
              Coach Sven gebruikt jouw trainingen, slaapdata, stappen en doelen om persoonlijke inzichten en advies te geven. Hier bepaal jij wat de assistent mag inzien.
            </p>
            ...
            <div className="flex items-center justify-between py-2 border-b border-border">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Sta Coach Sven toe om jou te begeleiden</p>
                </div>
              </div>
              <Switch
                checked={aiEnabled}
            ...
            {aiEnabled && (
              <div className="space-y-4 pl-1">
                ...
                <div className="rounded-lg bg-muted/60 p-3 text-xs text-muted-foreground leading-relaxed">
                  🔒 Je gegevens worden nooit gedeeld met derden. Coach Sven verwerkt data uitsluitend om jou persoonlijk advies te geven binnen de app.
                </div>
              </div>
            )}
          </CardContent>
